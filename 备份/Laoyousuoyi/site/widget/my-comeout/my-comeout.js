define(['backbone','template','my-comeout/tpl'], function (Backbone,T,tpl) {
    var Model = Backbone.Model.extend({
        ...
        getList: function () {
            var that =this;
            $.ajax({
                url:'/schoolBuy/api/my-comeout.php',
                type:'POST',
    ...
    var View = Backbone.View.extend({
        ...
        render: function () {
            this.$el.html(tpl.main).addClass('mod-my-comeout');
